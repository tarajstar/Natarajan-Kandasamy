...
{
    internal class OperatorButton : BaseButton
    {
        public static readonly DependencyProperty DisplayCharacterPropery =
            DependencyProperty.Register("DisplayCharacter", typeof(string), typeof(OperatorButton), new PropertyMetadata(string.Empty));
